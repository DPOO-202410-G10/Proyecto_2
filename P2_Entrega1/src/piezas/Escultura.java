...
public class Escultura extends Pieza{
	...
	public Escultura(String idPieza, String titulo, String lugarCreacion, double ancho, double alto, String fechaLimite,
					 String pieza, boolean valorFijo, double valorinicial, List<String> autores, Propietario propietario,
